$(function(){
  ...
  if($.fn.perfectScrollbar) {
    $('.bdskp-sidebar').perfectScrollbar({
  ...
  $('body').on('click', '.bdskp-direction', function(){
    var val = $(this).val();
  ...
  $('body').on('click', '.sticky-header', function(){
    ...
    if(val === 'yes') {
      ...
      $('body').addClass('bdskp-sticky-header');
    } else {
      $.removeCookie('sticky-header');
      $('body').removeClass('bdskp-sticky-header');
    }
  });

  // toggles sidebar to sticky
  $('body').on('click', '.sticky-sidebar', function(){
    if($('.bdskp-sidebar').length) {
      var val = $(this).val();
      if(val === 'yes') {
        $.cookie('sticky-sidebar', 'true');
        $('body').addClass('bdskp-sticky-sidebar');
      } else {
        $.removeCookie('sticky-sidebar');
        $('body').removeClass('bdskp-sticky-sidebar');
      }
    } else {
  ...
  $('body').on('click', '.full-width', function(){
    ...
    if(val === 'yes') {
      ...
      $('body').addClass('bdskp-full-width');
    } else {
      $.removeCookie('full-width');
      $('body').removeClass('bdskp-full-width');
    }
  });
