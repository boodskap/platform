...
RUN wget --no-check-certificate https://github.com/BoodskapPlatform/boodskap-platform/releases/download/3.0.1/boodskap-patch-3.0.1-10002.tar.gz
RUN tar -xzvf /root/boodskap-patch-3.0.1-10002.tar.gz
