...
docker pull boodskapiot/platform:3.0.1-10001
docker pull boodskapiot/gateway:3.0.1
...
docker container create --net platformnet -p 18080:18080 -p 19090:19090 -p 2021:2021 --ip 10.1.1.2 --hostname boodskap --name boodskap -v $VOL_BOODSKAP:/root/data boodskapiot/platform:3.0.1-10001
